class QuranVerse {
    ...
    fetchData(index, randomChapterVerse) {
        return new Promise(resolve => {
            ...
            fetch(`https://cdn.jsdelivr.net/gh/fawazahmed0/quran-api@1/editions/${this.options.translateEditionName}/${strRandomChapterVerse}.json`)
                .then((response) => response.json())
                .then((json) => {
                    quotes.translateQuote = json;

                    if (this.options.includeArabicVerse) {
                        return fetch(`https://cdn.jsdelivr.net/gh/fawazahmed0/quran-api@1/editions/${this.options.arabicEditionName}/${strRandomChapterVerse}.json`);
                    } else {
                        resolve(quotes);
                    }
                })
